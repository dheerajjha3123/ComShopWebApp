...
// Define props interface for TeamMemberCard
...
const TeamMemberCard = ({
  ...
  return (
    <div className="px-12 py-8 bg-gray-100 transition-colors duration-300 transform hover:scale-90 inset-shadow-sm inset-shadow-grey-500 cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-500 dark:border-gray-700 dark:hover:border-transparent hover:text-white ">
      ...
      <p className="mt-4 text-gray-500 capitalize dark:text-gray-300 group-hover:text-white">
        {description}
      </p>
      <div className="flex mt-4 -mx-2">
        ...
        {socialLinks.facebook && (
          <a
            ...
            rel="noopener noreferrer"
            className="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
            aria-label={`Facebook profile for ${name}`}
          >
            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {socialLinks.reddit && (
          <a
            ...
            rel="noopener noreferrer"
            className="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
            aria-label={`Reddit profile for ${name}`}
          >
            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
